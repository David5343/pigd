...
use App\Http\Controllers\Api\SocioeconomicBenefits\PensionerBeneficiaryApiController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/socioeconomic_benefits/workrisks/searchbypension/{id}', [WorkRiskApiController::class, 'searchbypension']);
    //Pensionados
    ...
    Route::get('/socioeconomic_benefits/pensioners/searchinsuredbyfilenumber/{file}', [PensionerApiController::class, 'searchinsuredbyfilenumber']);
    Route::put('/socioeconomic_benefits/pensioners/update/{id}', [PensionerApiController::class, 'update']);
    ...
    Route::get('/socioeconomic_benefits/pensionerbeneficiaries/searchbyfolio/{folio}', [PensionerBeneficiaryApiController::class, 'searchbyfolio']);
    ...
    Route::get('/socioeconomic_benefits/credentialpensionersb/search/{dato}', [CredentialPensionerBeneficiaryApiController::class, 'search']);
    //Turnos
