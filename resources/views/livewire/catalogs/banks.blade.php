                                    ...
                                    @foreach ($lista as $item)
                                        <tr class="border-b border-neutral-200 dark:border-white/10">
                                            ...
                                            <td class="px-6 py-4 relative group">
                                                ...
                                                <div
                                                    class="absolute z-50 top-full left-1/2 -translate-x-1/2 mt-1 w-full max-w-xs bg-gray-700 text-white text-xs rounded px-3 py-2 opacity-0 group-hover:opacity-100 transition whitespace-normal pointer-events-none shadow-lg">
                                                    {{ $item->legal_name }}
                                                </div>
                                            </td>
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <a
                                                    href="{{ url('human_resources/catalogs/banks/' . $item->id . '/edit') }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="size-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
