                        ...
                        <table class="min-w-full text-left text-sm font-light text-surface dark:text-white">
                            <thead class="border-b border-neutral-200 font-medium dark:border-white/10">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-4">No. de empleado</th>
                                    <th scope="col" class="px-6 py-4">Nombre del empleado</th>
                                    <th scope="col" class="px-6 py-4">Área</th>
                                    <th scope="col" class="px-6 py-4">Movimiento Nominal</th>
                                    <th scope="col" class="px-6 py-4">Fecha de ingreso</th>
