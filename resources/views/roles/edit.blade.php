<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-lg">
            ...
            @endsession
            <h2 class="text-xl font-bold text-gray-700 mb-4 mt-4">Roles de Sistema.</h2>
            <h5 class="text-base font-bold text-gray-700 mb-4">Convencion de Nombres (Ejemplo:ResponsableTransparencia)
            </h5>
            <form method="POST" class="flex flex-wrap gap-2" action="{{ url('roles/' . $row->id) }}">
                @method('PUT')
                @csrf
                @if ($errors->any())
