<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Recursos Humanos/Catalogos/Categorias/Editar') }}
        </h2>
    </x-slot>
    <div class="py-12">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <form method="POST" class="flex flex-wrap gap-2"
                        action="{{ url('human_resources/catalogs/categories/' . $row->id) }}">
                        @method('PUT')
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="flex flex-col w-full" x-data>
                            <div class="flex flex-col w-full md:w-1/5">
                                ...
                                <input type="text" id="salary" name="salary" maxlength="13" inputmode="decimal"
                        ...
                        <div class="flex flex-col w-full" x-data>
                            <div class="flex flex-col w-full md:w-1/5">
                                ...
                                <input type="text" id="compensation" name="compensation" maxlength="13"
                        ...
                        <div class="flex flex-col w-full" x-data>
                            <div class="flex flex-col w-full md:w-1/5">
                                <label for="complementary" class="text-sm font-medium text-gray-700">*
                                    Complementaria</label>
                                <input type="text" id="complementary" name="complementary" maxlength="13"
                                    inputmode="decimal" required
                                    class="border rounded-lg px-3 py-2 w-full focus:ring focus:ring-blue-200"
                        ...
                        <div class="flex flex-col w-full" x-data>
                            <div class="flex flex-col w-full md:w-1/5">
                                ...
                                <input type="text" id="isr" name="isr" maxlength="13"
                                    inputmode="decimal" required
                                    class="border rounded-lg px-3 py-2 w-full focus:ring focus:ring-blue-200"
                                    value="{{ $row->isr }}">
                            </div>
                        ...
                        <div class="flex flex-col w-full">
                            <div class="flex flex-col w-full md:w-1/6">
                                <label for="authorized_positions" class="text-sm font-medium text-gray-700">* Puestos
                                    autorizados</label>
                                <input type="number" id="authorized_position" name="authorized_position" required
                                    class="border rounded-lg px-3 py-2 w-full focus:ring focus:ring-blue-200"
                                    value="{{ $row->authorized_position }}">
                            </div>
