...
namespace App\Livewire\MaterialResources;

use Livewire\Component;

class SubMenuMaterialResources extends Component
{
    ...
    {
        return view('livewire.material-resources.sub-menu-material-resources');
    }
}
