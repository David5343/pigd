...
namespace App\Livewire\FinancialResources;

use Livewire\Component;

class SubMenuFinancialResources extends Component
{
    ...
    {
        return view('livewire.financial-resources.sub-menu-financial-resources');
    }
}
